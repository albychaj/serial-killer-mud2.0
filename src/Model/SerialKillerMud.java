...
public class SerialKillerMud implements Serializable
{
	...
	private void instantiateItems()
	{
		...
		stick = new FightingItem("stick","Use this fine piece of wood to protect yourself in anyway\npossible. It's more powerful than you think.", true, false, false);
		...
		handcuffs = new ReusableItem("handcuffs", "Use this to save yourself some time. MOB's will\nstruggle to get free from this restraint.", true, false, false);
